...
<div x-data="{ open: false }" class="relative">
    ...
    <button @click="open = !open"
            class="flex items-center px-2 py-2 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-sm font-medium hover:bg-slate-200 dark:hover:bg-slate-700 transition">
