      ...
      <div class="card-body">
        ...
        <form action="{{ route('kpi.update', ['employee_id' => $employees->id, 'month' => $month, 'year' => $year]) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <select class="select-form" type="hidden" name="employee_id" aria-label="Default select example" disabled readonly>
                        ...
                        <div class="col-md-3">
                            <select class="select-form" type="hidden" name="month" aria-label="Default select example" disabled readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <select class="select-form" type="hidden" name="employee_eid" aria-label="Default select example" disabled readonly>
                        ...
                        <div class="col-md-3">
                            <select class="select-form" type="hidden" name="year" aria-label="Default select example" disabled readonly>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-4">
                            <select class="select-form" type="hidden" name="employee_position" aria-label="Default select example" disabled readonly>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="input-form numeric-input text-end" name="grades[{{ $gradeKpi->indicator_id }}]" id="grade_{{ $gradeKpi->indicator_id }}" required value="{{ number_format($gradeKpi->achievement, 2, '.', ',') }}">
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
